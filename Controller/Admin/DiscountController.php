...
class DiscountController extends Controller
{
     ...
     *
     * @Route("/", name="cart_admin_discount")
     * @Method("GET")
     */
    public function indexAction(Request $request)
    {
        ...
        $this->get('event_dispatcher')
            ->dispatch(CoreEvents::DISCOUNT_LIST, $event);
     ...
     *
     * @Route("/", name="cart_admin_discount_create")
     * @Method("POST")
     */
    public function createAction(Request $request)
    {
        ...
        $formEvent->setObjectType($this->objectType)
            ->setEntity($entity)
            ->setRequest($request)
            ->setAction($this->generateUrl('cart_admin_discount_create'))
            ->setMethod('POST');
        ...
        if ($form->handleRequest($request)->isValid()) {
            ...
            $this->get('event_dispatcher')
                ->dispatch(CoreEvents::DISCOUNT_CREATE_RETURN, $returnEvent);
     ...
     *
     * @Route("/new", name="cart_admin_discount_new")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}", name="cart_admin_discount_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="cart_admin_discount_edit")
     * @Method("GET")
     */
    public function editAction(Request $request, $id)
    {
        ...
        $formEvent->setObjectType($this->objectType)
            ->setEntity($entity)
            ->setRequest($request)
            ->setAction($this->generateUrl('cart_admin_discount_update', ['id' => $entity->getId()]))
            ->setMethod('PUT');
     ...
     *
     * @Route("/{id}", name="cart_admin_discount_update")
     * @Method("PUT")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($form->handleRequest($request)->isValid()) {
            ...
            $returnEvent->setEntity($entity);
            $this->get('event_dispatcher')
                ->dispatch(CoreEvents::DISCOUNT_UPDATE_RETURN, $returnEvent);
     ...
     *
     * @Route("/{id}", name="cart_admin_discount_delete")
     * @Method("DELETE")
     */
     ...
     *
     * @Route("/mass_delete", name="cart_admin_discount_mass_delete")
     * @Method("POST")
     */
