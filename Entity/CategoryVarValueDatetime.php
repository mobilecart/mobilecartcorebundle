...
/**
 * MobileCart\CoreBundle\Entity\CategoryVarValueDatetime
 *
 * @ORM\Table(name="category_var_value_datetime")
 * @ORM\Entity
 */
class CategoryVarValueDatetime
    implements CartEntityVarValueInterface
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="MobileCart\CoreBundle\Entity\Category", inversedBy="var_values_datetime")
     * @ORM\JoinColumns({
