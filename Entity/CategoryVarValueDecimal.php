...
/**
 * MobileCart\CoreBundle\Entity\CategoryVarValueDecimal
 *
 * @ORM\Table(name="category_var_value_decimal")
 * @ORM\Entity
 */
class CategoryVarValueDecimal
    implements CartEntityVarValueInterface
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="MobileCart\CoreBundle\Entity\Category", inversedBy="var_values_decimal")
     * @ORM\JoinColumns({
