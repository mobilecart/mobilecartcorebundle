    ...
    implements CartEntityInterface, CartEntityVarOptionInterface
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="MobileCart\CoreBundle\Entity\ItemVar", inversedBy="item_var_options_int")
     * @ORM\JoinColumns({
    ...
    {
        return \MobileCart\CoreBundle\Constants\EntityConstants::ITEM_VAR_OPTION_INT;
    }
