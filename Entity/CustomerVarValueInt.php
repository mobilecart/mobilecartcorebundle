...
/**
 * MobileCart\CoreBundle\Entity\CustomerVarValueInt
 *
 * @ORM\Table(name="customer_var_value_int")
 * @ORM\Entity
 */
class CustomerVarValueInt
{
    /**
     * @var integer $id
     *
     ...
     *
     * @ORM\ManyToOne(targetEntity="MobileCart\CoreBundle\Entity\Customer", inversedBy="var_values_int")
     * @ORM\JoinColumns({
