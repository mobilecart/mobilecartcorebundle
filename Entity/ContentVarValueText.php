...
/**
 * MobileCart\CoreBundle\Entity\ContentVarValueText
 *
 * @ORM\Table(name="content_var_value_text")
 * @ORM\Entity
 */
class ContentVarValueText
    implements CartEntityVarValueInterface
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="MobileCart\CoreBundle\Entity\Content", inversedBy="var_values_text")
     * @ORM\JoinColumns({
