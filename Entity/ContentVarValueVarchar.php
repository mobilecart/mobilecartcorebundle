...
/**
 * MobileCart\CoreBundle\Entity\ContentVarValueVarchar
 *
 * @ORM\Table(name="content_var_value_varchar")
 * @ORM\Entity
 */
class ContentVarValueVarchar
{
    /**
     * @var integer $id
     *
     ...
     *
     * @ORM\ManyToOne(targetEntity="MobileCart\CoreBundle\Entity\Content", inversedBy="var_values_varchar")
     * @ORM\JoinColumns({
