...
/**
 * MobileCart\CoreBundle\Entity\CustomerVarValueDecimal
 *
 * @ORM\Table(name="customer_var_value_decimal")
 * @ORM\Entity
 */
class CustomerVarValueDecimal
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="MobileCart\CoreBundle\Entity\Customer", inversedBy="var_values_decimal")
     * @ORM\JoinColumns({
