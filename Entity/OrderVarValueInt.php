...
/**
 * MobileCart\CoreBundle\Entity\OrderVarValueInt
 *
 * @ORM\Table(name="order_var_value_int")
 * @ORM\Entity(repositoryClass="MobileCart\CoreBundle\Repository\CommonRepository")
 */
class OrderVarValueInt
    implements CartEntityVarValueInterface
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="MobileCart\CoreBundle\Entity\Order", inversedBy="var_values_int")
     * @ORM\JoinColumns({
