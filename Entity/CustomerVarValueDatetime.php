...
/**
 * MobileCart\CoreBundle\Entity\CustomerVarValueDatetime
 *
 * @ORM\Table(name="customer_var_value_datetime")
 * @ORM\Entity
 */
class CustomerVarValueDatetime
    implements CartEntityVarValueInterface
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="MobileCart\CoreBundle\Entity\Customer", inversedBy="var_values_datetime")
     * @ORM\JoinColumns({
