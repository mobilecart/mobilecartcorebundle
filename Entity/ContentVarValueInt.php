...
/**
 * MobileCart\CoreBundle\Entity\ContentVarValueInt
 *
 * @ORM\Table(name="content_var_value_int")
 * @ORM\Entity
 */
class ContentVarValueInt
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="MobileCart\CoreBundle\Entity\Content", inversedBy="var_values_int")
     * @ORM\JoinColumns({
