...
/**
 * MobileCart\CoreBundle\Entity\CategoryVarValueInt
 *
 * @ORM\Table(name="category_var_value_int")
 * @ORM\Entity
 */
class CategoryVarValueInt
    implements CartEntityVarValueInterface
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="MobileCart\CoreBundle\Entity\Category", inversedBy="var_values_int")
     * @ORM\JoinColumns({
