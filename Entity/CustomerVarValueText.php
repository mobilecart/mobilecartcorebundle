...
/**
 * MobileCart\CoreBundle\Entity\CustomerVarValueText
 *
 * @ORM\Table(name="customer_var_value_text")
 * @ORM\Entity
 */
    ...
    implements CartEntityVarValueInterface
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="MobileCart\CoreBundle\Entity\Customer", inversedBy="var_values_text")
     * @ORM\JoinColumns({
