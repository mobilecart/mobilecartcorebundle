...
/**
 * MobileCart\CoreBundle\Entity\CustomerVarValueVarchar
 *
 * @ORM\Table(name="customer_var_value_varchar")
 * @ORM\Entity
 */
class CustomerVarValueVarchar
    implements CartEntityVarValueInterface
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="MobileCart\CoreBundle\Entity\Customer", inversedBy="var_values_varchar")
     * @ORM\JoinColumns({
