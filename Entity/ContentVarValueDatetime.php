...
/**
 * MobileCart\CoreBundle\Entity\ContentVarValueDatetime
 *
 * @ORM\Table(name="content_var_value_datetime")
 * @ORM\Entity
 */
class ContentVarValueDatetime
    implements CartEntityVarValueInterface
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="MobileCart\CoreBundle\Entity\Content", inversedBy="var_values_datetime")
     * @ORM\JoinColumns({
